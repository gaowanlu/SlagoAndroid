...
public class Http_aboutList {
    public static List<String> fetch(int page, int pagesize){
        List<String> back=new ArrayList<>();
        try{
            OkHttpClient client=new OkHttpClient();
            Request nameRq= Utils.SessionRequest(APIData.URL_MIPR+"/aboutlist?page="+Integer.toString(page)+"&pagesize="+Integer.toString(pagesize));
            Gson gson=new Gson();
